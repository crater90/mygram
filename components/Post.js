import { addDoc, onSnapshot, query, collection, serverTimestamp, orderBy, setDoc, doc, deleteDoc } from "@firebase/firestore";
        ...
        <div className="bg-white my-7 border rounded-sm">
            ...
            <div className="flex justify-between px-4 pt-4">
                <div className="flex space-x-4">
                   {
                       hasLiked ? (
                           <Heartfilled onClick= {likePost} className="btn text-red-600"/>
                       ) : (
